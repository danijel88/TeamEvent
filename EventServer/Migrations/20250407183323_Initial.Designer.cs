...
namespace EventServer.Migrations
{
    ...
    [Migration("20250407183323_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventServer.Domain.Attenders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventServer.Domain.TeamEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventServer.Domain.Attenders", b =>
                {
                    b.HasOne("EventServer.Domain.TeamEvent", "TeamEvent")
                        .WithMany("Attenders")
